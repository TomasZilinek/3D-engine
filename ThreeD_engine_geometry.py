...
def dot_product(vector_1, vector_2):  # vectors u . v
...
def cross_product(vector_1, vector_2):  # vectors u x v
...
def sub_points(point_1, point_2):  # points A - B
...
def add_sub_vectors(vector_1, vector_2, sign):  # vectors u +- v
    if vector_1.dimensions != vector_2.dimensions:
        raise ValueError("Dimensions number difference")
